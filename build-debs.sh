...
build_arch() {
    ...
    rm -f "$OUT/travel-net_0.2.24-1_${arch}.deb"
...
EOF
    ...
    dpkg-deb -Zgzip --root-owner-group --build pkg_deb "$OUT/travel-net_0.2.24-1_${arch}.deb"
    echo "=== $arch -> $OUT/travel-net_0.2.24-1_${arch}.deb ==="
}
